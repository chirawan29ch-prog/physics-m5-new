...
function getRank(xp) {
  return XP_RANKS.find((r) => xp >= r.minXP) || XP_RANKS[XP_RANKS.length - 1];
}
...
const INIT_ASSIGNMENTS = [
  {
    id: 'A1',
    chapterId: 'CH1',
    title: 'ใบกิจกรรม 1.1: การเคลื่อนที่แบบ SHM',
    xp: 300,
    due: '30 พ.ค. 2568',
    desc: 'คำนวณคาบและความถี่',
    type: 'worksheet',
    createdAt: '20 พ.ค. 2568',
  },
  {
    id: 'A2',
    chapterId: 'CH1',
    title: 'แบบทดสอบ 1.2: พลังงานใน SHM',
    xp: 400,
    due: '5 มิ.ย. 2568',
    desc: '30 ข้อ multiple choice',
    type: 'quiz',
    createdAt: '20 พ.ค. 2568',
  },
  {
    id: 'A3',
    chapterId: 'CH2',
    title: 'ใบกิจกรรม 2.1: สมบัติของคลื่น',
    xp: 300,
    due: '12 มิ.ย. 2568',
    desc: 'การสะท้อน หักเห เลี้ยวเบน',
    type: 'worksheet',
    createdAt: '21 พ.ค. 2568',
  },
  {
    id: 'A4',
    chapterId: 'CH2',
    title: 'แบบทดสอบ 2.2: คลื่นเสียง',
    xp: 400,
    due: '18 มิ.ย. 2568',
    desc: '30 ข้อ multiple choice',
    type: 'quiz',
  ...
  },
  {
    id: 'A5',
    chapterId: 'CH3',
    title: 'ใบกิจกรรม 3.1: การแทรกสอดของแสง',
    xp: 350,
    due: '24 มิ.ย. 2568',
    desc: "Young's double slit",
    type: 'worksheet',
    createdAt: '22 พ.ค. 2568',
  },
  {
    id: 'A6',
    chapterId: 'CH3',
    title: 'Lab 3.2: การเลี้ยวเบนของแสง',
    xp: 400,
    due: '30 มิ.ย. 2568',
    desc: 'ทดลองกับ diffraction grating',
    type: 'lab',
    createdAt: '22 พ.ค. 2568',
  },
  {
    id: 'A7',
    chapterId: 'CH4',
    title: 'ใบกิจกรรม 4.1: กฎของสเนลล์',
    xp: 300,
    due: '5 ก.ค. 2568',
    desc: 'การหักเหของแสง',
    type: 'worksheet',
    createdAt: '23 พ.ค. 2568',
  },
  {
    id: 'A8',
    chapterId: 'CH4',
    title: 'แบบทดสอบ 4.2: เลนส์และกระจก',
    xp: 400,
    due: '10 ก.ค. 2568',
    desc: '30 ข้อ multiple choice',
    type: 'quiz',
...
const INIT_STUDENTS = [
  ...
  {
    id: 's5',
    name: 'นางสาว จันทร์ศุธา โพธิ์ล่าม',
    password: '18738',
    avatar: '👩‍🎓',
    xp: 0,
    submissions: {},
  ...
  {
    id: 's8',
    name: 'นางสาว ณัฐนิชา บุญวัดโพธิ์',
    password: '19205',
    avatar: '👩‍🎓',
    xp: 0,
    submissions: {},
  ...
  {
    id: 's16',
    name: 'นางสาว ขวัญพิชชา สำรวมจิต',
    password: '19124',
    avatar: '👩‍🎓',
    xp: 0,
    submissions: {},
  ...
  {
    id: 's17',
    name: 'นางสาว พิชชานันท์ แก้วบุบผา',
    password: '19126',
    avatar: '👩‍🎓',
    xp: 0,
    submissions: {},
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(180deg,#0a1628 0%,#0f2040 25%,#1a3060 50%,#1e3a5e 70%,#162840 100%)',
        }}
      />
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle,rgba(255,200,80,.35) 0%,rgba(255,140,40,.12) 50%,transparent 70%)',
          filter: 'blur(8px)',
        }}
      />
      ...
      <div
        style={{
          ...
          boxShadow:
            '0 0 30px rgba(212,192,96,.4),0 0 60px rgba(212,192,96,.15)',
        }}
      />
      ...
      <svg
        style={{ position: 'absolute', bottom: '26%', left: 0, width: '100%' }}
        height="130"
      ...
      <div
        style={{
          ...
          height: '10%',
          background:
            'linear-gradient(180deg,rgba(30,58,100,.6) 0%,rgba(20,40,75,.4) 100%)',
        }}
      />
      ...
      <div
        style={{
          ...
          height: '26%',
          background:
            'linear-gradient(180deg,#112038 0%,#162d4a 35%,#1a3456 70%,#152840 100%)',
      ...
      >
        ...
        {Array.from({ length: 9 }, (_, i) => (
          <div
            ...
            style={{
              ...
              right: '3%',
              height: 1,
              background: `rgba(100,160,220,${0.06 + i * 0.01})`,
              top: `${12 + i * 9}%`,
              borderRadius: 2,
              animation: `waterShimmer ${2.5 + i * 0.4}s ease-in-out infinite`,
        ...
        <div
          style={{
            ...
            height: '55%',
            background:
              'linear-gradient(180deg,rgba(255,220,80,.18),transparent)',
            borderRadius: 3,
        ...
        <div
          style={{
            ...
            height: '40%',
            background:
              'linear-gradient(180deg,rgba(255,220,80,.12),transparent)',
            borderRadius: 3,
        ...
        <div
          style={{
            ...
            bottom: '32%',
            left: '12%',
            animation: 'gondola 4s ease-in-out infinite',
            fontSize: 30,
        ...
        <div
          style={{
            ...
            bottom: '28%',
            left: '55%',
            animation: 'gondola 6s ease-in-out infinite',
            animationDelay: '.8s',
            fontSize: 18,
            opacity: 0.55,
      ...
      {[6, 18, 32, 46, 60, 74, 88].map((l, i) => (
        <div
          ...
          style={{
            ...
            animation: `pulse ${1.8 + i * 0.25}s ease-in-out infinite`,
      ...
      <div
        style={{
          ...
          opacity: 0.04,
          backgroundImage:
            'linear-gradient(rgba(100,160,220,.5) 1px,transparent 1px),linear-gradient(90deg,rgba(100,160,220,.5) 1px,transparent 1px)',
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(ellipse at center,transparent 35%,rgba(5,12,22,.55) 100%)',
        }}
      />
    </div>
  );
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          color: r.color,
          lineHeight: 1,
          textShadow: `0 0 18px ${r.color}66`,
        }}
      >
        {r.grade}
      </div>
      ...
      >
        <div
          style={{
            width: `${pct}%`,
            height: '100%',
            background: 'linear-gradient(90deg,#1a3a6a,#4a9edd,#f0c060)',
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '12px 8px',
                background:
                  i === 0 ? 'rgba(212,168,67,.1)' : 'rgba(255,255,255,.04)',
                border: `1px solid ${
                  i === 0 ? 'rgba(212,168,67,.35)' : 'var(--border)'
                }`,
                borderRadius: 8,
              }}
            >
  ...
  return (
    <div className="card" style={{ overflow: 'hidden' }}>
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: 'var(--muted2)', marginTop: 2 }}>
            XP เต็มเทอม 2,500 XP = 100 คะแนน
          </div>
        </div>
      </div>
      <div
      ...
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: '1.4fr 1.2fr 1fr .5fr .8fr',
          gap: 1,
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              position: 'relative',
              zIndex: 1,
              filter: `drop-shadow(0 0 30px ${airdrop.color})`,
            }}
          >
            {airdrop.icon}
          </div>
        ...
        <div
          ...
          style={{
            ...
            color: airdrop.color,
            marginBottom: 8,
            textShadow: `0 0 28px ${airdrop.color}`,
          }}
        >
          {airdrop.name}
        </div>
        <div
          className="badge"
          style={{
            background: `${airdrop.color}18`,
            border: `1px solid ${airdrop.color}55`,
            color: airdrop.color,
            fontSize: 13,
            padding: '5px 14px',
            marginBottom: 16,
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              color: 'var(--gold2)',
              lineHeight: 1,
              textShadow: '0 0 40px rgba(212,168,67,.55)',
            }}
          >
            PHYSICS
          </div>
        ...
        >
          ...
          >
            PHYSICS BATTLEGROUND © 2568 · VENICE EDITION
          </div>
        </div>
      </div>
    </div>
...
function TopNav({ user, role, page, setPage, onLogout }) {
  const sTabs = [
    ...
    { id: 'resources', label: 'เนื้อหา' },
    { id: 'assignments', label: 'ส่งงาน' },
    { id: 'ranking', label: 'RANKING' },
    { id: 'inventory', label: 'AIRDROP' },
    { id: 'settings', label: 'ตั้งค่า' },
  ];
  const tTabs = [
    { id: 'overview', label: 'OVERVIEW' },
    { id: 'students', label: 'STUDENTS' },
    { id: 't-assignments', label: '📋 งาน' },
    { id: 't-resources', label: '📁 ไฟล์' },
    { id: 't-scores', label: '⭐ XP' },
    { id: 't-exam', label: '📝 สอบ' },
    { id: 't-airdrop', label: '📦 AIRDROP' },
    { id: 'ranking', label: 'RANKING' },
  ];
      ...
      >
        <div
          ...
          style={{
            ...
            marginRight: 20,
            flexShrink: 0,
            textShadow: '0 0 18px rgba(212,168,67,.45)',
          }}
        >
          ⚡ PHYS·BG
        </div>
        <div style={{ display: 'flex', flex: 1, overflowX: 'auto', gap: 0 }}>
          {tabs.map((t) => (
            <button
              ...
              style={{
                background:
                  page === t.id ? 'rgba(212,168,67,.08)' : 'transparent',
                padding: '0 14px',
                height: 54,
        ...
        >
          ...
          <div style={{ lineHeight: 1.3 }}>
            ...
            >
              {role === 'teacher' ? 'COMMANDER' : getRank(user?.xp || 0).label}
            </div>
          </div>
          <button
  ...
  return (
    <div style={{ padding: '16px 20px 4px' }}>
      ...
      >
        ...
        <span
          className="mono"
          style={{ fontSize: 10, color: 'var(--muted)', letterSpacing: 2 }}
        >
          {meta.back.toUpperCase()}
        </span>
...
function ScoreBreakdown({ student, assignments }) {
  ...
  function earnedXP(list) {
    return list.reduce((s, a) => {
      const sub = student.submissions?.[a.id];
      return s + (sub ? sub.xpEarned || 0 : 0);
    }, 0);
  }
  const score1 = Math.min(MAX_HALF, Math.round(earnedXP(first) / 25));
  const score2 = Math.min(MAX_HALF, Math.round(earnedXP(second) / 25));
  const scoreMid = student.midterm,
    scoreFinal = student.final;
  const totalAnnounced =
    score1 +
    score2 +
    (scoreMid !== null ? scoreMid : 0) +
    (scoreFinal !== null ? scoreFinal : 0);
  const maxAnnounced =
    MAX_HALF +
    MAX_HALF +
    (scoreMid !== null ? MAX_MID : 0) +
    (scoreFinal !== null ? MAX_FINAL : 0);
  const pct1 = Math.round((score1 / MAX_HALF) * 100);
  const pct2 = Math.round((score2 / MAX_HALF) * 100);
  const pctMid =
    scoreMid !== null ? Math.round((scoreMid / MAX_MID) * 100) : null;
  function tip() {
    const w = [];
  ...
  const segs = [
    {
      label: 'เก็บ ก่อนกลางภาค',
      w: 35,
      bg: '#d8b4fe',
      txt: '#3b0764',
      cbg: 'rgba(216,180,254,.12)',
      cbr: 'rgba(216,180,254,.35)',
      bar: '#a78bfa',
      score: score1,
      max: MAX_HALF,
      pct: pct1,
    ...
    },
    {
      ...
      bg: '#93c5fd',
      txt: '#1e3a8a',
      cbg: 'rgba(147,197,253,.12)',
      cbr: 'rgba(147,197,253,.35)',
      bar: '#60a5fa',
      score: scoreMid,
      max: MAX_MID,
      pct: pctMid,
    ...
    {
      label: 'เก็บ หลังกลางภาค',
      w: 35,
      bg: '#f9a8d4',
      txt: '#500724',
      cbg: 'rgba(249,168,212,.12)',
      cbr: 'rgba(249,168,212,.35)',
      bar: '#f472b6',
      score: score2,
      max: MAX_HALF,
      pct: pct2,
    ...
    },
    {
      ...
      bg: '#fde68a',
      txt: '#451a03',
      cbg: 'rgba(253,230,138,.08)',
      cbr: 'rgba(253,230,138,.3)',
      bar: '#fbbf24',
      score: scoreFinal,
      max: MAX_FINAL,
      pct: null,
    ...
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      <div
        style={{
          ...
          border: '0.5px solid rgba(212,168,67,.25)',
          borderRadius: 8,
          padding: '10px 14px',
          display: 'flex',
          justifyContent: 'space-between',
...
function StudentDashboard({
  ...
  function changePw() {
    if (oldPw !== student.password) {
      setPwMsg({ t: 'err', text: 'รหัสผ่านเดิมไม่ถูกต้อง' });
      return;
    }
    if (newPw.length < 4) {
      setPwMsg({ t: 'err', text: 'รหัสผ่านใหม่ต้องมีอย่างน้อย 4 ตัว' });
      return;
    }
    if (newPw !== cnf) {
      setPwMsg({ t: 'err', text: 'รหัสผ่านใหม่ไม่ตรงกัน' });
      return;
    }
    setStudents((prev) =>
      prev.map((s) => (s.id === student.id ? { ...s, password: newPw } : s))
    );
  ...
  return (
    <div
      className="fade-up"
      style={{ padding: 20, maxWidth: 1000, margin: '0 auto' }}
    >
      {pwModal && (
        <div className="overlay">
          ...
          >
            ...
            {(
              [
                ['รหัสผ่านเดิม', oldPw, setOldPw],
                ['รหัสผ่านใหม่', newPw, setNewPw],
                ['ยืนยันรหัสผ่านใหม่', cnf, setCnf],
            ...
            {pwMsg && (
              <div
                style={{
                  ...
                  borderRadius: 5,
                  padding: '9px 14px',
                  color: pwMsg.t === 'ok' ? 'var(--green)' : 'var(--red)',
                  fontSize: 13,
                  marginBottom: 12,
                }}
              >
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <span
                ...
                style={{
                  ...
                  border: '1px solid rgba(77,184,112,.35)',
                  color: 'var(--green)',
                }}
              >
                ✓ {submitted}/{assignments.length} งาน
              </span>
            </div>
          </div>
      ...
      >
        ...
        <div>
          <div
            className="card"
            style={{ marginBottom: 10, textAlign: 'center', padding: 14 }}
          >
            <div
              className="mono"
              style={{
          ...
          >
            <div className="card" style={{ textAlign: 'center', padding: 12 }}>
              ...
              <div
                className="cond"
                style={{ fontSize: 28, fontWeight: 700, color: 'var(--cyan)' }}
              >
                {submitted}
              </div>
              <div style={{ fontSize: 11, color: 'var(--muted)' }}>ส่งแล้ว</div>
            </div>
            <div className="card" style={{ textAlign: 'center', padding: 12 }}>
              <div style={{ fontSize: 22, marginBottom: 4 }}>⏳</div>
              <div
              ...
              <div style={{ fontSize: 11, color: 'var(--muted)' }}>ค้างส่ง</div>
            </div>
          </div>
        </div>
      </div>
...
function StudentAssignments({ student, assignments, setStudents }) {
    ...
    setStudents((prev) =>
      prev.map((s) =>
        s.id === student.id
          ? {
              ...s,
              xp: s.xp + (uploadModal.xp || 0),
              submissions: {
                ...s.submissions,
                [uploadModal.id]: {
                  file: fileName,
                  submittedAt: today,
                  xpEarned: uploadModal.xp,
                },
              },
            }
          : s
  ...
  function removeSubmission(id) {
    setStudents((prev) =>
      prev.map((s) => {
        ...
        return { ...s, xp: s.xp - (sub?.xpEarned || 0), submissions: rest };
      })
    );
  }
  ...
  return (
    ...
    >
      {uploadModal && (
        <div className="overlay">
          ...
          >
            ...
            <div
              style={{ color: 'var(--muted2)', fontSize: 13, marginBottom: 4 }}
            >
              {uploadModal.title}
            </div>
            <div
              className="mono"
              style={{ color: 'var(--gold)', fontSize: 13, marginBottom: 20 }}
            >
              +{uploadModal.xp} XP
            </div>
            <div
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                ...
                onClick={submitWork}
                disabled={!fileName}
                style={{ flex: 1, opacity: fileName ? 1 : 0.4 }}
              >
                ✅ ส่งงาน (+{uploadModal.xp} XP)
              </button>
              <button
                className="btn-outline"
      ...
      >
        MISSION BOARD — {assignments.length} OBJECTIVES
      </div>
      {CHAPTERS.map((ch) => {
        const chA = assignments.filter((a) => a.chapterId === ch.id);
        if (!chA.length) return null;
        return (
          <div key={ch.id} style={{ marginBottom: 28 }}>
            <div
              style={{
                ...
                marginBottom: 12,
                paddingBottom: 10,
                borderBottom: `1px solid ${ch.color}30`,
              }}
            >
              ...
              <div>
                ...
                <div
                  className="cond"
                  style={{ fontSize: 22, fontWeight: 700, color: ch.color }}
                >
                  {ch.title}
                </div>
              </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    marginBottom: 8,
                    borderColor: sub ? `${ch.color}44` : 'var(--border)',
                    background: sub
                      ? `linear-gradient(135deg,var(--bg2),${ch.bg})`
                      : 'var(--bg2)',
                  }}
                >
        ...
        return (
          <div key={ch.id} style={{ marginBottom: 24 }}>
            ...
            >
              ...
              <div
                className="cond"
                style={{ fontSize: 20, fontWeight: 700, color: ch.color }}
              >
                {ch.title}
              </div>
              <span
          ...
          <div
            ...
            style={{
              ...
              borderColor: isMe
                ...
                ? 'rgba(212,168,67,.22)'
                : 'var(--border)',
              background: isMe ? 'rgba(212,168,67,.06)' : 'var(--bg2)',
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ maxWidth: 300 }}>
                <XPBar xp={s.xp} showLabel={false} />
              </div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div
                className="cond"
                style={{ fontSize: 32, fontWeight: 900, color: r.color }}
              >
                {s.xp.toLocaleString()}
              </div>
              <div style={{ fontSize: 10, color: 'var(--muted)' }}>XP</div>
...
function StudentInventory({ student }) {
  const rb = {
    LEGENDARY: 'rgba(240,192,96,.08)',
    EPIC: 'rgba(155,127,232,.08)',
    RARE: 'rgba(61,184,160,.08)',
    UNCOMMON: 'rgba(125,232,160,.06)',
    COMMON: 'rgba(100,100,100,.06)',
  };
  return (
    <div
      className="fade-up"
    ...
    >
      ...
      >
        AIRDROP INVENTORY — {student.inventory.length} ITEMS
      </div>
      {student.inventory.length === 0 ? (
        <div className="card" style={{ textAlign: 'center', padding: 60 }}>
          <div style={{ fontSize: 48, marginBottom: 12 }}>📦</div>
          <div className="cond" style={{ fontSize: 20, color: 'var(--muted)' }}>
            ยังไม่มีรางวัล
          </div>
            ...
            >
              <div
                style={{
                  fontSize: 52,
                  marginBottom: 10,
                  filter: `drop-shadow(0 0 16px ${item.color}66)`,
                }}
              >
                {item.icon}
              </div>
...
function StudentSettings({ student, setStudents }) {
  ...
  function change() {
    if (oldPw !== student.password) {
      setMsg({ t: 'err', text: 'รหัสผ่านเดิมไม่ถูกต้อง' });
      return;
    }
    if (newPw.length < 4) {
      setMsg({ t: 'err', text: 'รหัสผ่านใหม่ต้องมีอย่างน้อย 4 ตัว' });
      return;
    }
    if (newPw !== cnf) {
      setMsg({ t: 'err', text: 'รหัสผ่านใหม่ไม่ตรงกัน' });
      return;
    }
    setStudents((prev) =>
      prev.map((s) => (s.id === student.id ? { ...s, password: newPw } : s))
    );
    setMsg({ t: 'ok', text: 'เปลี่ยนรหัสผ่านสำเร็จ! ✅' });
    setOldPw('');
    setNewPw('');
    setCnf('');
  }
  return (
    <div
      className="fade-up"
      style={{ padding: 20, maxWidth: 480, margin: '0 auto' }}
    >
      <div
        className="mono"
        style={{
      ...
      <div className="card">
        ...
        {msg && (
          <div
            style={{
              background:
                msg.t === 'ok' ? 'rgba(77,184,112,.12)' : 'rgba(224,82,82,.12)',
              border: `1px solid ${
                msg.t === 'ok' ? 'rgba(77,184,112,.4)' : 'rgba(224,82,82,.4)'
              }`,
              borderRadius: 5,
              padding: '9px 14px',
...
function TeacherExamScores({ students, setStudents }) {
  const [midScores, setMidScores] = useState(() => {
    ...
    students.forEach((s) => {
      m[s.id] =
        s.midterm !== null && s.midterm !== undefined ? String(s.midterm) : '';
    });
    return m;
  });
  const [finalScores, setFinalScores] = useState(() => {
    ...
    students.forEach((s) => {
      m[s.id] =
        s.final !== null && s.final !== undefined ? String(s.final) : '';
    });
    return m;
  });
  ...
  return (
    ...
    >
      ...
      {saved && (
        ...
        >
          ✅ บันทึกแล้ว — คะแนนแสดงในหน้านักเรียนทันที!
        </div>
      )}
      <div
        style={{
      ...
      >
        <div className="card" style={{ borderColor: 'rgba(147,197,253,.5)' }}>
          ...
          <div
            className="mono"
            style={{ fontSize: 10, color: 'var(--muted)', marginBottom: 14 }}
          >
            คะแนนเต็ม 15 คะแนน
          </div>
          {students.map((s) => (
            ...
            >
              ...
              <input
                ...
                min="0"
                max="15"
                value={midScores[s.id] || ''}
                placeholder="—"
                onChange={(e) =>
                  setMidScores((p) => ({ ...p, [s.id]: e.target.value }))
                }
                style={{
                  width: 60,
                  background: 'rgba(14,26,43,.7)',
          ...
          {students.map((s) => (
            ...
            >
              ...
              <input
                ...
                min="0"
                max="15"
                value={finalScores[s.id] || ''}
                placeholder="—"
                onChange={(e) =>
                  setFinalScores((p) => ({ ...p, [s.id]: e.target.value }))
                }
                style={{
                  width: 60,
                  background: 'rgba(14,26,43,.7)',
...
function GradeChart({ students }) {
  ...
  useEffect(() => {
    ...
    barInst.current = new Chart(chartRef.current, {
      ...
      data: {
        labels,
        datasets: [
          { label: 'จำนวน', data, backgroundColor: colors, borderRadius: 6 },
        ],
      },
      options: {
        responsive: true,
        ...
        animation: {
          onComplete(e) {
            const ch = e.chart,
              cv = ch.ctx;
            cv.font = 'bold 11px sans-serif';
            cv.textAlign = 'center';
            cv.textBaseline = 'bottom';
            ch.data.datasets[0].data.forEach((v, i) => {
              if (!v) return;
              const b = ch.getDatasetMeta(0).data[i];
              cv.fillStyle = '#f0e8d0';
              cv.fillText(v + ' คน', b.x, b.y - 3);
            });
          },
        },
      },
    ...
    const nz = labels
      .map((l, i) => ({ l, d: data[i], c: colors[i] }))
      .filter((x) => x.d > 0);
    pieInst.current = new Chart(pieRef.current, {
      type: 'doughnut',
      data: {
        labels: nz.map((x) => 'เกรด ' + x.l),
        datasets: [
          {
            data: nz.map((x) => x.d),
            backgroundColor: nz.map((x) => x.c),
            borderWidth: 3,
            borderColor: 'rgba(6,12,26,.9)',
          },
        ],
      },
      options: {
        ...
        animation: {
          onComplete(e) {
            const ch = e.chart,
              cv = ch.ctx,
              tot2 = nz.reduce((a, x) => a + x.d, 0);
            ch.data.datasets[0].data.forEach((v, i) => {
              if (!v) return;
              const arc = ch.getDatasetMeta(0).data[i];
              const mid = (arc.startAngle + arc.endAngle) / 2,
                r = arc.outerRadius * 0.68,
                x2 = arc.x + Math.cos(mid) * r,
                y2 = arc.y + Math.sin(mid) * r;
              cv.font = 'bold 12px sans-serif';
              cv.fillStyle = '#fff';
              cv.textAlign = 'center';
              cv.textBaseline = 'middle';
              cv.fillText(Math.round((v / tot2) * 100) + '%', x2, y2 - 6);
              cv.font = '10px sans-serif';
              cv.fillText(v + ' คน', x2, y2 + 7);
            });
          },
        },
      },
  ...
  function exportCSV() {
    let csv = 'เกรด,จำนวนนักเรียน\n';
    labels.forEach((l, i) => {
      if (data[i] > 0) csv += `${l},${data[i]}\n`;
    });
    const a = document.createElement('a');
    a.href = URL.createObjectURL(new Blob([csv], { type: 'text/csv' }));
    a.download = 'grade_summary.csv';
    a.click();
  }
  function exportPNG() {
    const a = document.createElement('a');
    a.href = chartRef.current.toDataURL('image/png');
    a.download = 'grade_bar.png';
    a.click();
  }
    ...
    <div className="card card-gold" style={{ marginBottom: 16 }}>
      ...
      >
        <div>
          <div
            className="cond"
            style={{ fontSize: 20, color: 'var(--gold2)', letterSpacing: 2 }}
          >
            📊 สรุปผลการเรียนทั้งห้อง
          </div>
          <div
            className="mono"
            style={{ fontSize: 10, color: 'var(--muted)', marginTop: 2 }}
          >
            Physics Battleground · เทอม 1/2568 · นักเรียน {total} คน
          </div>
        </div>
      ...
      >
        {[
          { label: 'นักเรียน', val: total, color: 'var(--cyan)' },
          { label: 'เกรดเฉลี่ย', val: avgGPA, color: 'var(--gold)' },
          { label: 'ผ่านเกณฑ์', val: passing + ' คน', color: 'var(--green)' },
          {
            label: 'ไม่ผ่าน',
            val: total - passing + ' คน',
            color: 'var(--red)',
          },
        ].map((s, i) => (
          <div
      ...
      >
        {nzL.map((x) => {
          const p = Math.round((x.d / total) * 100);
          return (
            <span
              key={x.l}
              style={{
...
function TeacherOverview({ students, assignments, setPage }) {
  const avgXP = Math.round(
    students.reduce((a, s) => a + s.xp, 0) / students.length
  );
  const passing = students.filter(
    (s) => parseFloat(getRank(s.xp).grade) > 0
  ).length;
  return (
    <div
      className="fade-up"
    ...
    >
      ...
      >
        {[
          ...
          },
          {
            icon: '❌',
            label: 'ไม่ผ่าน',
            val: students.length - passing,
            color: 'var(--red)',
          },
          {
            icon: '⭐',
            label: 'XP เฉลี่ย',
            val: avgXP.toLocaleString(),
            color: 'var(--gold)',
          },
          {
            icon: '📋',
          ...
          <div
            key={i}
            className="card"
            style={{ textAlign: 'center', borderColor: `${s.color}33` }}
          >
            <div style={{ fontSize: 24, marginBottom: 4 }}>{s.icon}</div>
            <div
              className="cond"
              style={{ fontSize: 34, fontWeight: 900, color: s.color }}
            >
              {s.val}
            </div>
      ...
      >
        ⚡ จัดการ — กดเพื่อไปหน้านั้นได้เลย
      </div>
      <div
        style={{
          display: 'grid',
        ...
        {[
          {
            page: 't-assignments',
            icon: '📋',
            title: 'เพิ่ม / จัดการงาน',
            desc: 'เพิ่มงานใหม่ ลบงาน มอบหมายภารกิจ',
            color: 'var(--cyan)',
            btn: '➕ เพิ่มงานใหม่',
          },
          {
            page: 't-resources',
            icon: '📁',
            title: 'อัปโหลดไฟล์ความรู้',
            desc: 'สไลด์ PDF เอกสารประกอบ',
            color: 'var(--gold)',
            btn: '⬆ อัปโหลดไฟล์',
          },
          {
            page: 't-scores',
            icon: '⭐',
            title: 'จัดการ XP / คะแนน',
            desc: 'เพิ่มหรือกำหนด XP รายบุคคล',
            color: '#82e0aa',
            btn: '✏️ แก้ไข XP',
          },
          {
            page: 't-airdrop',
            icon: '📦',
            title: 'ส่ง Airdrop รางวัล',
            desc: 'สุ่มรางวัลตาม Event ที่กำหนด',
            color: 'var(--purple)',
            btn: '🎲 Roll Airdrop',
          },
        ].map((a) => (
          <div
            ...
            style={{
              ...
              background: `linear-gradient(135deg,var(--bg2),${a.color}0a)`,
            }}
          >
            <div
              style={{
          ...
          .map((s) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="mono"
                  style={{ width: 64, textAlign: 'right', color: r.color }}
                >
                  {s.xp.toLocaleString()}
                </div>
                <GradeTag xp={s.xp} />
                ...
                {sub ? (
                  <span
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(77,184,112,.3)',
                      color: 'var(--green)',
                    }}
                  >
                    ✓ ส่งแล้ว
      ...
      {[...students]
        ...
        .map((s, i) => {
          ...
          return (
            <div
              key={s.id}
              className="card card-hover slide-r"
              onClick={() => setSel(s.id)}
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            >
              ...
              <div className="mono" style={{ fontSize: 20, color: r.color }}>
                {s.xp.toLocaleString()}
              </div>
              <GradeTag xp={s.xp} />
...
function TeacherAssignments({
  ...
  function save() {
    ...
    setAssignments((prev) => [
      ...prev,
      { ...form, id: 'A' + Date.now(), xp: Number(form.xp), createdAt: today },
    ]);
    setModal(false);
    setForm({
      chapterId: 'CH1',
  ...
  const submitted = checkModal
    ? students.filter((s) => s.submissions?.[checkModal.id])
    : [];
  const notSubmitted = checkModal
    ? students.filter((s) => !s.submissions?.[checkModal.id])
    : [];
    ...
    >
      ...
      {modal && (
        <div className="overlay">
          ...
          >
            ...
            {[
              ['ชื่องาน / หัวข้อ', 'title', 'text'],
              ['XP รางวัล', 'xp', 'number'],
              ['วันครบกำหนด', 'due', 'text'],
              ['รายละเอียด', 'desc', 'text'],
            ].map(([l, k, t]) => (
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                className="btn btn-gold"
                onClick={save}
                style={{ flex: 1, fontSize: 16, padding: 13 }}
              >
                💾 บันทึกงาน
              </button>
              <button
        ...
        <div className="overlay">
          <div
            ...
            style={{
              ...
              maxHeight: '85vh',
              overflowY: 'auto',
              borderColor: 'rgba(61,184,160,.35)',
              boxShadow: '0 0 32px rgba(61,184,160,.1)',
            }}
          >
            <div
              style={{
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        padding: '12px 14px',
                        marginBottom: 8,
                        background: 'rgba(77,184,112,.05)',
                        border: '1px solid rgba(77,184,112,.2)',
                        borderRadius: 8,
                      }}
                    >
                      ...
                      >
                        <div style={{ textAlign: 'right' }}>
                          ...
                          <input
                            type="number"
                            value={editXp[s.id] ?? sub.xpEarned}
                            min={0}
                            max={checkModal.xp * 2}
                            onChange={(e) =>
                              setEditXp((p) => ({
      ...
      >
        <div>
          <div
            className="mono"
            style={{ fontSize: 10, color: 'var(--muted)', letterSpacing: 3 }}
          >
            MISSION CONTROL
          </div>
          <div
            className="cond"
            style={{ fontSize: 22, color: 'var(--text)', marginTop: 2 }}
          >
            {assignments.length} งาน / ภารกิจ
          </div>
        </div>
        <button
          className="btn btn-gold"
...
function TeacherResources({ resources, setResources }) {
  ...
  function save() {
    ...
    setResources((prev) => [
      ...prev,
      { ...form, id: 'R' + Date.now(), uploadedAt: today },
    ]);
    setModal(false);
    setForm({ chapterId: 'CH1', title: '', type: 'pdf', link: '' });
  }
  function del(id) {
    if (window.confirm('ลบไฟล์นี้?'))
  ...
  return (
    ...
    >
        ...
        <div className="overlay">
          ...
          >
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                💡 เปิด Google Drive → คลิกขวาไฟล์ → "Get link" → วางที่นี่
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                className="btn btn-gold"
                onClick={save}
                style={{ flex: 1, fontSize: 15, padding: 13 }}
              >
                ✅ บันทึก
              </button>
              <button
      ...
      >
        💡 ใส่ลิงก์ Google Drive เพื่อให้นักเรียนเปิดไฟล์ได้เลย
        ไม่ต้องอัปโหลดไฟล์จริง
      </div>
      {CHAPTERS.map((ch) => {
        const chR = resources.filter((r) => r.chapterId === ch.id);
        return (
          <div key={ch.id} style={{ marginBottom: 24 }}>
            ...
            {chR.length === 0 && (
              <div style={{ color: 'var(--muted)', fontSize: 13 }}>
                ยังไม่มีไฟล์ — กด "เพิ่มไฟล์ใหม่" เพื่อเพิ่มครับ
              </div>
            )}
            {chR.map((r) => (
              <div
...
function TeacherScores({ students, setStudents }) {
  ...
  function addXP() {
    ...
    setStudents((prev) =>
      prev.map((s) =>
        s.id === selStu ? { ...s, xp: s.xp + Number(xpAmt) } : s
      )
    );
    toast(
      `✅ เพิ่ม ${xpAmt} XP ให้ ${students.find((s) => s.id === selStu)?.name}!`
    );
    setXpAmt('');
  }
  function setXPFixed() {
    if (!selStu || !xpAmt) return;
    setStudents((prev) =>
      prev.map((s) => (s.id === selStu ? { ...s, xp: Number(xpAmt) } : s))
    );
    toast(
      `✅ กำหนด XP ${students.find((s) => s.id === selStu)?.name} = ${xpAmt}!`
    );
    setXpAmt('');
  }
  return (
        ...
        >
          <div>
            ...
            <select
              className="input"
              value={selStu}
              onChange={(e) => setSelStu(e.target.value)}
            >
              <option value="">-- เลือกนักเรียน --</option>
              {students.map((s) => (
                <option key={s.id} value={s.id}>
                  {s.avatar} {s.name} · {s.xp.toLocaleString()} XP
                </option>
              ))}
            </select>
          </div>
          ...
          .map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="mono"
                  style={{ width: 70, textAlign: 'right', color: r.color }}
                >
                  {s.xp.toLocaleString()}
                </div>
                <GradeTag xp={s.xp} />
...
function TeacherAirdrop({ students, setPendingAirdrop }) {
  ...
  const RARITY_BG = {
    LEGENDARY: 'rgba(240,192,96,.1)',
    EPIC: 'rgba(155,127,232,.1)',
    RARE: 'rgba(61,184,160,.1)',
    UNCOMMON: 'rgba(125,232,160,.07)',
    CUSTOM: 'rgba(224,123,58,.1)',
    COMMON: 'rgba(100,100,100,.07)',
  };
  ...
  function getFiltered() {
    switch (eventFilter) {
      case 'no_drop':
        return students.filter((s) => s.inventory.length === 0);
      case 'low_xp': {
        const mn = Math.min(...students.map((s) => s.xp));
        return students.filter((s) => s.xp === mn);
      }
      case 'top': {
        const mx = Math.max(...students.map((s) => s.xp));
        return students.filter((s) => s.xp === mx);
      }
      case 'pending': {
        const mp = Math.max(
          ...students.map((s) => Object.keys(s.submissions || {}).length)
        );
        return students
          .filter((s) => Object.keys(s.submissions || {}).length === mp)
          .slice(0, 1);
      }
      default:
        return students;
  ...
  function startRoll() {
    ...
    timerRef.current = setInterval(() => {
      setRollIdx(Math.floor(Math.random() * pool.length));
      c++;
      if (c >= 28) {
  ...
  return (
    ...
    >
      ...
      <div className="card card-gold" style={{ marginBottom: 14 }}>
        <div
          style={{
            ...
            justifyContent: 'space-between',
            alignItems: 'center',
            marginBottom: showPoolEditor ? 16 : 0,
          }}
        >
          <div>
            <div
              className="cond"
              style={{ fontSize: 18, color: 'var(--gold)', letterSpacing: 2 }}
            >
              🎁 จัดการ Reward Pool
            </div>
            <div style={{ fontSize: 12, color: 'var(--muted)', marginTop: 2 }}>
              {pool.length} รางวัลในกล่อง
            </div>
          </div>
          <button
            className="btn btn-gold"
            onClick={() => setShowPoolEditor((p) => !p)}
          ...
          <>
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setAddForm((p) => ({ ...p, rarity: e.target.value }))
                    }
                  >
            ...
            >
              {pool.map((r) => (
                <div
                  ...
                  style={{
                    ...
                    gap: 10,
                    padding: '10px 12px',
                    background: RARITY_BG[r.rarity] || 'rgba(100,100,100,.06)',
                    borderRadius: 7,
                    border: `1px solid ${r.color}44`,
                    position: 'relative',
                  }}
              ...
              {pool.length === 0 && (
                ...
                >
                  ⚠ ไม่มีรางวัลในกล่อง — กรุณาเพิ่มก่อน Roll
                </div>
              )}
            </div>
          </>
      ...
      <div
        className="card"
        style={{ marginBottom: 14, borderColor: 'rgba(155,127,232,.3)' }}
      >
        <div
          className="cond"
          style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <button
            className="btn btn-gold"
            onClick={startRoll}
            disabled={!selStu || rolling || pool.length === 0}
            style={{
              padding: 18,
              fontSize: 20,
              display: 'flex',
              ...
              justifyContent: 'center',
              gap: 10,
              opacity: !selStu || rolling || pool.length === 0 ? 0.4 : 1,
            }}
          >
            {rolling ? (
              <>
        ...
        >
          {!rolling && !result && (
            <div>
              <div style={{ fontSize: 56, opacity: 0.2, marginBottom: 8 }}>
                📦
              </div>
              <div
                className="mono"
              ...
              >
                กด ROLL เพื่อสุ่มรางวัล
              </div>
            </div>
          )}
          {rolling && pool[rollIdx] && (
            <div>
              <div
                style={{ fontSize: 76, animation: 'spin .18s linear infinite' }}
              >
                {pool[rollIdx].icon}
              </div>
              <div
            ...
            <div className="air-in">
              <div
                style={{
                  fontSize: 72,
                  marginBottom: 10,
                  filter: `drop-shadow(0 0 22px ${result.color})`,
                }}
              >
                {result.icon}
              </div>
...
// ─────────────────────────────────────────────
const GAS_URL =
  'https://script.google.com/macros/s/AKfycbzSILLYJdp-slFsZec0Ozp8WKJZFYc0BqyJ6-pZnontW0gl7IrgbedJA52B08keK0Lnyw/exec'; // ← ใส่ Web App URL ตรงนี้
...
export default function App() {
  ...
  useEffect(() => {
    if (loaded) gasSave('saveStudents', students);
  }, [students]);
  useEffect(() => {
    if (loaded) gasSave('saveAssignments', assignments);
  }, [assignments]);
  useEffect(() => {
    if (loaded) gasSave('saveResources', resources);
  }, [resources]);
  ...
  const navUser =
    role === 'teacher'
      ? { name: 'ครูผู้สอน', avatar: '👩‍✈️', xp: 9999 }
      : currentStudent;
  ...
  return (
    <>
      <style>{G}</style>
      <VeniceBackground />
      {activePopup && role === 'student' && (
        <AirdropPopup
          airdrop={activePopup}
          onClaim={() => setActivePopup(null)}
        />
      )}
      <div style={{ position: 'relative', zIndex: 1, minHeight: '100vh' }}>
        ...
        <main>
          ...
          {role === 'student' && page === 'dashboard' && currentStudent && (
            <StudentDashboard
          ...
          {role === 'student' && page === 'assignments' && currentStudent && (
            <StudentAssignments
              student={currentStudent}
              assignments={assignments}
              setStudents={setStudents}
          ...
          {role === 'student' && page === 'resources' && (
            <StudentResources resources={resources} />
          )}
          {role === 'student' && page === 'ranking' && (
            <RankingPage students={students} myId={userId} />
          )}
          {role === 'student' && page === 'inventory' && currentStudent && (
            <StudentInventory student={currentStudent} />
          )}
          {role === 'student' && page === 'settings' && currentStudent && (
            <StudentSettings
              student={currentStudent}
              setStudents={setStudents}
            />
          )}
          {role === 'teacher' && page === 'overview' && (
            <TeacherOverview
              students={students}
              assignments={assignments}
              setPage={setPage}
          ...
          {role === 'teacher' && page === 'students' && (
            <TeacherStudents students={students} assignments={assignments} />
          )}
          {role === 'teacher' && page === 't-assignments' && (
            <TeacherAssignments
              assignments={assignments}
          ...
          {role === 'teacher' && page === 't-resources' && (
            <TeacherResources
              resources={resources}
              setResources={setResources}
            />
          )}
          {role === 'teacher' && page === 't-scores' && (
            <TeacherScores students={students} setStudents={setStudents} />
          )}
          {role === 'teacher' && page === 't-exam' && (
            <TeacherExamScores students={students} setStudents={setStudents} />
          )}
          {role === 'teacher' && page === 't-airdrop' && (
            <TeacherAirdrop
              students={students}
              setPendingAirdrop={setPendingAirdrop}
            />
          )}
          {role === 'teacher' && page === 'ranking' && (
            <RankingPage students={students} myId={undefined} />
          )}
        </main>
      </div>
    </>
